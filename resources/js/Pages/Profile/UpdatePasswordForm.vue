    ...
    <jet-form-section @submitted="updatePassword">
        ...
        <template #form>
            <div class="col-span-6 sm:col-span-4">
                <jet-label class="text-gray-600" for="current_password" value="Current Password" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label class="text-gray-600" for="password" value="New Password" />
            ...
            <div class="col-span-6 sm:col-span-4">
                <jet-label class="text-gray-600" for="password_confirmation" value="Confirm Password" />
