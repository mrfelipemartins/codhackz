        ...
        <template #content>
            <div class="bg-gray-800 rounded p-4">
                ...
                <div class="float-right">
                    ...
                    <button class="btn btn-success" :disabled="loading" @click="save"><b-spinner small v-if="loading"></b-spinner> Create</button>
                </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            save() {
                this.loading = true
                this.$inertia.post(route('accounts.store'), this.form).then(res => {
                    this.loading = false
                })
            }
        }
